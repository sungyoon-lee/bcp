...
if __name__ == "__main__":
    ...
    try:
        aa = torch.load(args.test_pth,map_location='cuda:'+str(args.cuda_ids))['state_dict'][0]
    except:
        aa = torch.load(args.test_pth,map_location='cuda:'+str(args.cuda_ids))['state_dict']
